...
**问题**: 原始设计过于"中规中矩"，可能遗漏非常规但影响巨大的事件。

**解决方案**: Prompt 现在包含 **4 大类事件**，特别强调对非常规事件的敏感度：

1. **常规重大事件** - 财报、合同、产品等
2. **黑天鹅/突发事件** ⚠️ - 安全事故、供应链中断、产品召回等
3. **舆情/声誉危机** ⚠️ - 公关危机、消费者抵制、劳工纠纷等
4. **政治/地缘风险** ⚠️ - 贸易政策、制裁、监管突变等
...
这确保既不会遗漏黑天鹅事件，也不会过度提取无关新闻。

**真实案例**:
```
✅ 提取: "特斯拉上海工厂因疫情封控停产两周" (供应链中断)
✅ 提取: "美国政府禁止苹果使用华为5G芯片" (政治风险)
✅ 提取: "波音737 MAX发生第三起致命事故" (产品安全危机)
❌ 排除: "某分析师称特斯拉可能面临供应链压力" (预测/观点)
```
